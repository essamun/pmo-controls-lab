...
[![PMO](https://img.shields.io/badge/Domain-Portfolio%20%26%20PMO-0056b3)](https://github.com/yourusername/pmo-controls-lab)
[![Power BI](https://img.shields.io/badge/Tool-Power%20BI-F2C811?logo=powerbi&logoColor=black)](https://github.com/yourusername/pmo-controls-lab)
[![Excel](https://img.shields.io/badge/Tool-Excel%20%2B%20Formulas-217346?logo=microsoftexcel&logoColor=white)](https://github.com/yourusername/pmo-controls-lab)
[![Status](https://img.shields.io/badge/Status-Active%20%2F%20Continuously%20Updated-brightgreen)](https://github.com/yourusername/pmo-controls-lab)
...
- [Week 1 — Intake Governance & Stage Gates](#week-1--intake-governance--stage-gates)
- [Week 2 — Project Controls & Power BI Dashboard](#week-2--project-controls--power-bi-dashboard)
- [Week 3 — Resource & Capacity Planning](#week-3--resource--capacity-planning)
- [Week 4 — Executive PMO Pack & Automation](#week-4--executive-pmo-pack--automation)
...
## Week 1 — Intake Governance & Stage Gates
...
## Week 2 — Project Controls & Power BI Dashboard
...
| E002 | P003 Basel IV | Issue — testing backlog, OSFI Apr 30 immovable | CRO | 18 | Yes |
| E003 | P001 CRM Upgrade | Overdue update — PM not submitted Feb status | PM: TBC | 11 | No |
| E004 | P010 Cloud Infrastructure | Risk — SA unavailable until Sep-26 | CTO | 23 | Yes |
| E005 | P008 Finance Reporting | Decision — early go-live Apr 30 vs May 31 | CFO / IT Ops | 8 | No |
| E006 | P006 Branch Refresh | Risk — vendor contracts auto-trigger Mar 22 | COO | 27 | Yes |

**0 overdue updates** as at Feb 28, 2026 — all 10 projects share the Feb-2026 reporting period. This is a positive governance signal: the PMO's Monday reminder automation (Week 4) is working.

---

## Week 3 — Resource & Capacity Planning
...
## Week 4 — Executive PMO Pack & Automation
...
### 3-Slide Executive Pack Structure

**Slide 1 — Portfolio Health Overview**
10 projects · RAG distribution · One-line status per project · Key movements this period

**Slide 2 — Delivery & Financial Outlook**
Amber and Red projects only · Schedule delay in weeks · Cost variance in dollars · Top 3 active risks

**Slide 3 — Decisions Required (the most important slide)**
...
| Monthly Dashboard Export | Last Friday of month, 4:00pm | Power BI → PDF → archive email | ~30 min/month |
...
pmo-controls-lab/
├── README.md
├── screenshots/                          ← All Power BI and Excel visuals
...
│   └── PMO_Methodology_Brief_v1.0.pdf         ← PMO operating model document
└── dashboard/
...
This repo reflects the completed lab as of April 2026. Planned enhancements:

- [ ] **Smartsheet integration** — migrate intake register to Smartsheet with automated approval workflows and cross-sheet formula linking
- [ ] **Jira intake board** — live demand management board replacing static intake register (board configuration and workflow screenshots to follow)
- [ ] **Power BI Service publish** — publish dashboard to Power BI Service with scheduled refresh (currently Desktop only)
- [ ] **Power Automate flow exports** — add flow screenshots and JSON exports to `/automation` folder
...
**Connect:** [LinkedIn](https://linkedin.com/in/yourusername) · [GitHub](https://github.com/yourusername)
